...
void Process_Control_Packet(uint8_t *data) {
    ...
    motor1_target_speed = ((uint16_t)packet->speed1_high << 8) | packet->speed1_low;
    motor1_target_speed -= 10000;
    motor2_target_speed = ((uint16_t)packet->speed2_high << 8) | packet->speed2_low;
    motor2_target_speed -= 10000;
